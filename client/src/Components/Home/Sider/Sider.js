...
class Sider extends  React.Component{
	...
	changeCss = (e)=>{
		...
		this.props.setTechnology({tech_num : techs.indexOf(e.target.id)+1, technology : e.target.id })
	}

	componentDidMount(){

		this.props.setTechnology({tech_num : this.state.tech_num, technology : this.state.technology })
